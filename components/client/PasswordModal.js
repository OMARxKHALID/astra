        ...
        <form onSubmit={handleSubmit} className="px-8 py-6 space-y-4">
          <div className="relative">
            <input
              ...
              maxLength={64}
              className="w-full border rounded-[2rem] px-5 py-3.5 text-sm font-mono outline-none transition-all pr-12"
              style={{
          ...
          <button
            type="submit"
            disabled={!pw.trim()}
            className="w-full h-12 rounded-[2rem] bg-amber-500 text-void font-black text-sm uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-amber-400 active:scale-[0.98] transition-all disabled:opacity-40 disabled:pointer-events-none shadow-lg shadow-amber-500/15 ring-1 ring-amber-400/40"
          >
            Join Room
          </button>
        </form>
