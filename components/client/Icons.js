...
export function LockSmallIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function UnlockSmallIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function CcIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
// Used for the strictVideoUrlMode toggle button in the navbar.
...
// Seek / jump-to notification icon used for haptic seek feedback toast.
export function SeekIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
