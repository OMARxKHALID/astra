// Sync is considered "good" when drift is below this threshold
export const SYNC_TOLERANCE_S = 0.15; // was 0.3 — tighter for better accuracy
export const SOFT_CORRECT_MAX_S = 2.0;
export const PLAYBACK_RATE_FAST = 1.06; // slightly more aggressive catch-up
export const PLAYBACK_RATE_SLOW = 0.94;
export const HEARTBEAT_INTERVAL = 5_000;
export const SYNC_CHECK_INTERVAL = 500; // was 1000ms — check twice per second
