...
export default function VideoPoster({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-3 text-center px-6 py-5 rounded-[var(--radius-panel)] bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl max-w-xs">
