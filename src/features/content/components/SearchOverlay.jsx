    ...
    >
      <div className="w-full max-w-[640px] mb-6 relative animate-in zoom-in-95 duration-300">
        ...
        <input
          ...
          className="w-full glass-card !bg-[var(--color-surface)]/40 border-white/5 !backdrop-blur-3xl rounded-[var(--radius-pill)] py-4 pr-12 pl-[52px] text-bright text-base font-body outline-none focus:border-amber focus-visible:ring-2 focus-visible:ring-amber/40 transition-all placeholder:text-white/20 shadow-2xl"
        />
        {loading ? (
