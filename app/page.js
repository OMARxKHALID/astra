...
export const metadata = {
  ...
  description: "Create a private room, share the link, watch any video in perfect real-time sync with friends.",
};
  ...
  return (
    <main className="min-h-dvh flex flex-col items-center justify-center px-4 py-16 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md grid grid-cols-2 gap-3">
        <FeatureCell icon="⚡" title="Real-time sync" desc="Frame-perfect playback across all viewers" />
        <FeatureCell icon="💬" title="Live chat" desc="React and chat as you watch" />
        <FeatureCell icon="🎬" title="Host controls" desc="Play, pause, and seek for the whole room" />
        <FeatureCell icon="🔗" title="Instant sharing" desc="One link — no account needed" />
      </div>
